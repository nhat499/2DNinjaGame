class Knight {
  constructor(game, x, y) {
    ...
    this.healthBar = new HealthBar(this, 60, 50);
  }
  ...
  loadAnimations() {
    ...
    this.animations['attack' + 'right'] = new Animator(
      this.spritesheet,
      5120,
      512,
      512,
    ...
    this.animations['attack' + 'left'] = new Animator(
      this.spritesheet,
      0,
      512,
      512,
    ...
    this.animations['slash' + 'right'] = new Animator(
      this.slashSheet,
      0,
      0,
      1024,
    ...
    this.animations['slash' + 'left'] = new Animator(
      this.slashSheet,
      0,
      1024,
      1024,
    ...
    this.animations['dmg' + 'right'] = new Animator(
      this.spritesheet,
      5120,
      1024,
      512,
    ...
    this.animations['dmg' + 'left'] = new Animator(
      this.spritesheet,
      4096,
      1024,
      512,
    ...
    this.animations['walk' + 'right'] = new Animator(
      this.spritesheet,
      5120,
      1536,
      512,
    ...
    this.animations['walk' + 'left'] = new Animator(
      this.spritesheet,
      0,
      1536,
      512,
  ...
  draw(ctx) {
    ...
    if (this.action === 'attack') {
      ...
      this.animations['slash' + this.facing].drawFrame(
        this.game.clockTick,
        ctx,
        this.x + buffer,
        this.y - 64,
