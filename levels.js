...
let level1 = {
    // ground locations
    grounds: [{x: -200, y: 700, width: 3840}, {x: 300, y: 0, width: 1920}, {x: 150, y: -500, width: 1920}],
    ...
    platforms:[{x: 1180, y: 550, width: 128}, {x: 1564, y:400, width: 128}, {x: 200, y:-190, width: 128}, 
        ...
        {x: 1824, y:-1250, width: 128}, {x: 2208, y:-1401, width: 128}],
   
    // walls
    walls: [{x: -200, y: -710, height: 1536},{x: 2360, y: -1400, height: 2176}, {x: 2092, y: 1, height: 512}, {x: 3512, y: -1400, height: 2176}],

    // monster
    slimes: [{x: 1600, y: 350}, {x: 1200, y: 450}, {x: 1600, y: 350}, 
        {x: 1600, y: -300}, {x: 1300, y: -300},{x: 1400, y: -300}, {x: 3000, y: -700, boss: true}],
        //[{x: 800, y: 0}], // {x: 640, y: 0}, {x: 680, y: 0}, {x: 720, y: 0}, {x: 760, y: 0}]
